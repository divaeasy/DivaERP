...
-- Compatible with the actual database schema

-- Clear existing test data (reverse order for FK constraints)
DELETE FROM lignepiece;
DELETE FROM entetepiece;
DELETE FROM article;
DELETE FROM clients;
...
INSERT INTO dossier (id, nom, adresse, logo, rc, devise_id, factureno) VALUES
...
-- Insert Reglements
INSERT INTO reglement (id, libelle, echeance, created_at, updated_at) VALUES
(1, 'Virement', 30, NOW(), NOW()),
(2, 'Ch̬que', 45, NOW(), NOW()),
(3, 'Esp̬ces', 0, NOW(), NOW()),
(4, 'Carte Bancaire', 0, NOW(), NOW()),
(5, 'Pr̩l̬vement', 60, NOW(), NOW());

-- Insert Clients (matching actual schema: dossier_id, nom, adr1, adr2, rue, tel, email, web, linkedin)
INSERT INTO clients (id, dossier_id, nom, adr1, adr2, rue, tel, email, web, linkedin, created_at, updated_at) VALUES
(1, 1, 'Client A', '100 Avenue A', '', 'Rue Alpha', '0612345678', 'client.a@example.com', 'www.clienta.com', '', NOW(), NOW()),
(2, 1, 'Client B', '200 Avenue B', '', 'Rue Beta', '0623456789', 'client.b@example.com', 'www.clientb.com', '', NOW(), NOW()),
(3, 2, 'Client C', '300 Avenue C', '', 'Rue Gamma', '0634567890', 'client.c@example.com', 'www.clientc.com', '', NOW(), NOW()),
(4, 2, 'Client D', '400 Avenue D', '', 'Rue Delta', '0645678901', 'client.d@example.com', 'www.clientd.com', '', NOW(), NOW()),
(5, 3, 'Client E', '500 Avenue E', '', 'Rue Epsilon', '0656789012', 'client.e@example.com', 'www.cliente.com', '', NOW(), NOW()),
(6, 3, 'Client F', '600 Avenue F', '', 'Rue Zeta', '0667890123', 'client.f@example.com', 'www.clientf.com', '', NOW(), NOW()),
(7, 4, 'Client G', '700 Avenue G', '', 'Rue Eta', '0678901234', 'client.g@example.com', 'www.clientg.com', '', NOW(), NOW()),
(8, 4, 'Client H', '800 Avenue H', '', 'Rue Theta', '0689012345', 'client.h@example.com', 'www.clienth.com', '', NOW(), NOW()),
(9, 5, 'Client I', '900 Avenue I', '', 'Rue Iota', '0690123456', 'client.i@example.com', 'www.clienti.com', '', NOW(), NOW()),
(10, 5, 'Client J', '1000 Avenue J', '', 'Rue Kappa', '0601234567', 'client.j@example.com', 'www.clientj.com', '', NOW(), NOW());

-- Insert Articles (Products)
INSERT INTO article (id, libelle, unite_id, tarif_id, dossier_id, created_at, updated_at) VALUES
...
INSERT INTO entetepiece (id, type, typet, tier_id, pieceno, pieceref, devise_id, remise, delai, reglement_id, statut, edition, rapport, montant, dossier_id, datep, created_at, updated_at) VALUES
